# SPEC-M2-001: M2 Viewers -- Pane Splitting + Tab UI + Command Palette + 4 Surfaces + CI/CD
...
**[If]** CI 가 실패하면 (If CI fails), 시스템은 Slack 또는 GitHub 알림으로 실패 사유를 **통지해야 한다** (shall notify).
